<template>
  <div class="hello">
    ...
    <div class="container">
      <div class="product">
        <div class="product-card">
          <h2 class="name">Samsung</h2>
          <h3 class="version">Galaxy A30s</h3>
          <span class="price">฿ 5,500</span>
          <a class="popup-btn">Quick View</a>
          <img
            class="product-img"
            src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcTp92X8-Kj_MO9VfUgaYHVsNHgwjs-Bnqitfa3Oxytxj_tWEiwiZJUattPML3_y5kfNkRWtIWrmYyS-KroZQmmam73j31ebOSp3caU&usqp=CAY"
            alt=""
          />
        </div>
        <div class="popup-view">
          <div class="popup-card">
            ...
            <div class="info">
              <h2>Samsung<br /><span>Galaxy A30s</span></h2>
              <p>จอแสดงผล Super AMOLED 24-bit (16 ล้านสี)</p>
              <p>
                หน้าจอหยดน้ำ (Waterdrop Display) กว้าง 6.4 นิ้ว (แนวทะแยง)
              </p>
              <p>
              ...
              <p>หน่วยความจำ ROM 64 RAM 4 , แบตเตอรี่ 4,000 mAh , Exynos 7885 Octa Core</p>
              <div class="select-con">
                <h5 class="text">Color :</h5>
                <select name="" id="" class="select">
                  <option value="" class="red">Red</option>
      ...
      <div class="product">
        <div class="product-card">
          <h2 class="name">Samsung</h2>
          <h3 class="version">Galaxy A01</h3>
          <span class="price">฿ 2,994</span>
          <a class="popup-btn">Quick View</a>
          <img
            class="product-img"
            src="https://res.cloudinary.com/cenergy-innovation-limited-head-office/image/fetch/c_scale,q_70,f_auto,h_740/https://d1dtruvuor2iuy.cloudfront.net/media/catalog/product/0/0/000252358_t.jpg"
            alt=""
          />
        </div>
        <div class="popup-view">
          <div class="popup-card">
            ...
            <div class="info">
              <h2>Samsung<br /><span>Galaxy A01</span></h2>
              <p>จอแสดงผล IPS TFT 24-bit (16 ล้านสี)</p>
              <p>
                หน้าจอหยดน้ำ (Waterdrop Display) - กว้าง 5.7 นิ้ว (แนวทะแยง)
              </p>
              <p>
               ความละเอียด 720 x 1560 พิกเซล (297 ppi)
              </p>
              <p>
              ...
              <p>หน่วยความจำ ROM 16GB  RAM 2GB , แบตเตอรี่ 3,000 mAh , หน่วยประมวลผล : Qualcomm Snapdragon 439 Octa Core</p>
              <div class="select-con">
                <h5 class="text">Color :</h5>
                <select name="" id="" class="select">
                  <option value="" class="red">Red</option>
      ...
      <div class="product">
        <div class="product-card">
          <h2 class="name">Samsung</h2>
          <h3 class="version">Galaxy A50S</h3>
          <span class="price">฿ 8,420</span>
          <a class="popup-btn">Quick View</a>
          <img
            class="product-img"
            src="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcRAhV_kuwybQ4XOqK7CjclGhNyI9SiiVIgJwCYspB9Tz3dl--p1&usqp=CAY"
            alt=""
          />
        </div>
        <div class="popup-view">
          <div class="popup-card">
            ...
            <div class="info">
              <h2>Samsung<br /><span>Galaxy A50S</span></h2>
              <p>จอแสดงผล Super AMOLED 24-bit (16 ล้านสี)</p>
              <p>
                หน้าจอหยดน้ำ (Waterdrop Display) กว้าง 6.4 นิ้ว (แนวทะแยง) 
              </p>
              <p>
               ความละเอียด 1080 x 2340 พิกเซล (403 ppi)
              </p>
              <p>
              ...
              <p>หน่วยความจำ ROM 128GB  RAM 6GB , แบตเตอรี่ 4,000 mAh , หน่วยประมวลผล :Exynos 9611 Octa Core</p>
              <div class="select-con">
                <h5 class="text">Color :</h5>
                <select name="" id="" class="select">
                  <option value="" class="red">Red</option>
    ...
    <div class="container">
      ...
      <div class="product">
        <div class="product-card">
          ...
          <img
            class="product-img"
            src="https://media-dtaconline.dtac.co.th/catalog/product/cache/e96373d1c57081d0b326a3dfa1f55e67/s/e/se_wh_3_5.jpg"
            alt=""
          />
        </div>
        <div class="popup-view">
          <div class="popup-card">
            ...
            <div class="info">
              <h2>iphone<br /><span>iPhone SE 64GB (2020)</span></h2>
              <p>จอภาพ Multi‑Touch ไวด์สกรีน แบบ LCD ขนาด 4.7 นิ้ว (แนวทแยง) พร้อมเทคโนโลยี IPS</p>
              <p>
              ...
              <p>หน่วยความจำ 	64GB  ชิพ A13 Bionic</p>
              <div class="select-con">
                <h5 class="text">Color :</h5>
                <select name="" id="" class="select">
                  <option value="" class="red">Red</option>
    ...
    <div class="container">
      <div class="product">
        <div class="product-card">
          <h2 class="name">Oppo</h2>
          <h3 class="version">Reno 5 Pro 5G</h3>
          <span class="price">฿ 19,990</span>
          <a class="popup-btn">Quick View</a>
          <img
            class="product-img"
            src="https://dynamic-cdn.eggdigital.com/uRuDDOFp.jpg"
            alt=""
          />
        </div>
        <div class="popup-view">
          <div class="popup-card">
            ...
            <div class="info">
              <h2>Oppo<br /><span>Reno 5 Pro 5G</span></h2>
              <p>จอภาพ Retina 10.2</p>
              <p>
                หน้าจอขนาด 6.55 นิ้ว ความละเอียด 1080x2400, FHD+,90Hz,
              </p>
              <p>
                4 กล้องหลัง: 64MP(f/1.7) + 8MP(f/2.2) + 2MP(f/2.4) + 2MP(f/2.4) กล้องหน้า: ความละเอียด 44MP(f/2.4)
              </p>
              <p>
                รองรับ 5G แบบ Dual-mode 5G
              </p>
              <p>หน่วยความจำ RAM 12 GB / ROM 256 GB MediaTek MT6889 Dimensity 1000+ 5G Octa-core 2.6 GHz</p>
              <div class="select-con">
                <h5 class="text">Color :</h5>
                <select name="" id="" class="select">
                  <option value="" class="red">Red</option>
      ...
      <div class="product">
        <div class="product-card">
          <h2 class="name">Oppo</h2>
          <h3 class="version">Reno 4</h3>
          <span class="price">฿ 10,990</span>
          <a class="popup-btn">Quick View</a>
          <img
            class="product-img"
            src="https://dynamic-cdn.eggdigital.com/ed810lrpN.jpg"
            alt=""
          />
        </div>
        <div class="popup-view">
          <div class="popup-card">
            ...
            <div class="info">
              <h2>Oppo<br /><span>Reno 4</span></h2>
              <p>หน้าจอขนาด 6.4" ความละเอียด 1080 x 2400, FHD+</p>
              <p>
      ...
      <div class="product">
        <div class="product-card">
          <h2 class="name">Oppo</h2>
          <h3 class="version">A93</h3>
          <span class="price">฿ 8,999</span>
          <a class="popup-btn">Quick View</a>
          <img
            class="product-img"
            src="https://dynamic-cdn.eggdigital.com/cZAFAexsd.jpg"
            alt=""
          />
        </div>
        <div class="popup-view">
          <div class="popup-card">
            ...
            <div class="info">
              <h2>Oppo<br /><span>A93</span></h2>
              <p>หน้าจอ LAMOLED, Punch-hole Display ขนาด 6.43 นิ้ว ความละเอียดระดับ FHD+ (2400x1080 พิกเซล) Refresh Rate 60Hz</p>
              <p>
              ...
              <p>หน่วยความจำ 128GB / RAM 8GB รองรับ microSD card เพิ่มได้ถึง 256 GB  MediaTek Helio P95 (MT6779V) Octa-core 2.2 GHz</p>
              <div class="select-con">
                <h5 class="text">Color :</h5>
                <select name="" id="" class="select">
                  <option value="" class="red">Red</option>
    ...
    <div class="container">
      <div class="product">
        <div class="product-card">
          <h2 class="name">Xiaomi</h2>
          <h3 class="version">Mi 10T Pro 5G</h3>
          <span class="price">฿ 15,990</span>
          <a class="popup-btn">Quick View</a>
          <img
            class="product-img"
            src="https://dynamic-cdn.eggdigital.com/c9d0ILmMP.jpg"
            alt=""
          />
        </div>
        <div class="popup-view">
          <div class="popup-card">
            ...
            <div class="info">
              <h2>Xiaomi<br /><span>Mi 10T Pro 5G</span></h2>
              <p>หน้าจอ 144Hz LCD ขนาด 6.67 นิ้ว</p>
              <p>
                กล้องหลัง ความละเอียด 108+13+5MP กล้องหน้า ความละเอียด 20 ล้านพิกเซล,
              </p>
              <p>
                รองรับ 5G แบบ Dual-mode 5G รองรับ 2 ซิม (นาโนซิม)
              </p>
              <p>
                แบตเตอรี่ 5000 mAh
              </p>
              <p>หน่วยความจำ 256 GB / RAM 8 GB Qualcomm Snapdragon 865 (7nm)</p>
              <div class="select-con">
                <h5 class="text">Color :</h5>
                <select name="" id="" class="select">
                  <option value="" class="red">Red</option>
      ...
      <div class="product">
        <div class="product-card">
          <h2 class="name">Xiaomi</h2>
          <h3 class="version">Mi A3</h3>
          <span class="price">฿ 6,897</span>
          <a class="popup-btn">Quick View</a>
          <img
            class="product-img"
            src="https://imgaz3.staticbg.com/thumb/large/oaupload/banggood/images/36/AB/ba7b2915-0e44-460c-ae2f-8ebaa3b269f3.jpg.webp"
            alt=""
          />
        </div>
        <div class="popup-view">
          <div class="popup-card">
            ...
            <div class="info">
              <h2>Xiaomi<br /><span>Mi A3</span></h2>
              <p>จอแสดงผล Super AMOLED 24-bit (16 ล้านสี)</p>
              <p>
              ...
              <p>หน่วยความจำ 64 GB / RAM 4 GB  Snapdragon 665, Octa-core สูงสุด 2.0GHz</p>
              <div class="select-con">
                <h5 class="text">Color :</h5>
                <select name="" id="" class="select">
                  <option value="" class="red">Red</option>
      ...
      <div class="product">
        <div class="product-card">
          <h2 class="name">Xiaomi</h2>
          <h3 class="version">Redmi note 8</h3>
          <span class="price">฿ 5,990</span>
          <a class="popup-btn">Quick View</a>
          <img
            class="product-img"
            src="https://imgaz.staticbg.com/thumb/large/oaupload/ser1/banggood/images/80/8B/12b44626-3bb0-46d3-8db5-5c293a74944f.jpg.webp"
            alt=""
          />
        </div>
        <div class="popup-view">
          <div class="popup-card">
            ...
            <div class="info">
              <h2>Xiaomi<br /><span>Redmi note 8</span></h2>
              <p>หน้าจอ 144Hz LCD ขนาด 6.67 นิ้ว</p>
              <p>
                กล้องหลัง Quad: 48.0MP + 8.0MP + 2.0MP + 2.0MP
              </p>
              <p>
                รองรับ 2 ซิมการ์ด ใช้งาน Nano-SIM
              </p>
              <p>
                แบตเตอรี่ 4000mAh
              </p>
              <p>หน่วยความจำ ROM 64 GB / RAM 4 GB  Snapdragon 665, Octa-core สูงสุด 2.0GHz</p>
              <div class="select-con">
                <h5 class="text">Color :</h5>
                <select name="" id="" class="select">
                  <option value="" class="red">Red</option>
  ...
  methods: {
    ...
    oppoReno5Pro5G() {
      ...
      const dataText = {
        ...
        price: 19990,
        img:
          "https://dynamic-cdn.eggdigital.com/uRuDDOFp.jpg",
      };
    ...
    oppoReno4() {
      ...
      const dataText = {
        ...
        price: 10990,
        img:
          "https://dynamic-cdn.eggdigital.com/ed810lrpN.jpg",
      };
    ...
    oppoA93() {
      ...
      const dataText = {
        ...
        price: 8999,
        img:
          "https://dynamic-cdn.eggdigital.com/cZAFAexsd.jpg",
      };
    ...
    XiaomiMi10TPro5G() {
      ...
      const dataText = {
        ...
        price: 15990,
        img:
          "https://dynamic-cdn.eggdigital.com/c9d0ILmMP.jpg",
      };
